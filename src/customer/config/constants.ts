...
export const CUSTOMER_TOOLBAR_MORE_OPTIONS: LabelValueIcon[] = [
  {
    label: 'Import',
...
export const CUSTOMER_CATEGORY_MARKETING_LIST = 'marketing_list'; //2
...
export const CUSTOMER_CATEGORY_ENUM: any = {
...
export const MARKETING_CUSTOMER_SOURCE_ENUM: any = {
  [CUSTOMER_CATEGORY_ACCOUNT]: 'MARKETING_MEMBER_SOURCE_ACCOUNT',
  [CUSTOMER_CATEGORY_CONTACT]: 'MARKETING_MEMBER_SOURCE_CONTACT',
  [CUSTOMER_CATEGORY_MARKETING_LIST]: 'MARKETING_MEMBER_SOURCE_MARKETING'
};
