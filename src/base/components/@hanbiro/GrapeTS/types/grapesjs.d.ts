...
export declare module grapesjs {
  ...
  interface TraitView {
    ...
    onEvent?: (options: { elInput: HTMLElement; component: Component; event: any }) => void;
    onUpdate?: (options: { elInput: HTMLElement; component: Component }) => void;
  ...
  interface Editor {
     ...
     */
    getCss(opts?: { component?: Component; json?: boolean; avoidProtected?: boolean; onlyMatched?: boolean }): string | CssRule[];
    /**
  ...
  /**
   *   style:custom event that will let you know when is the right moment to create/update your UI.
   */
  type StyleManagerEvent = 'styleManager:update:target' | 'styleManager:change' | 'styleManager:change:{propertyName}' | 'style:custom';
  ...
  interface AssetManager {
     ...
     */
    open(options?: { types?: String[]; select?: (...params: any[]) => any }): void;
    /**
  ...
  interface Component extends Backbone.Model<ComponentOptions> {
     ...
     * @returns HTML string
     */
    toHTML(opts?: { tag?: string; attributes?: any | ((...params: any[]) => any); withProps?: boolean; altQuoteAttr?: boolean }): string;
  ...
  interface Sector extends Backbone.Model<SectorOptions> {
     ...
     */
    getProperties(opts?: { withValue?: boolean; withParentValue?: boolean }): Property[];
  }
  ...
  interface Modal {
     ...
     */
    open(opts?: { title?: string | HTMLElement; content?: string | HTMLElement; attributes?: any }): this;
    /**
