 ...
 * @returns {Element}
 */
export function make(tagName: string, classNames: any, attributes?: any): HTMLElement {
 ...
 */
export function getCursorPositionRelativeToElement(elem: HTMLElement, event: any) {
  const rect = elem.getBoundingClientRect();
