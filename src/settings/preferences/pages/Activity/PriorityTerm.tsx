...
const PriorityTerm = (props: PriorityTermProps) => {
    ...
    () => [
      {
        ...
        header: () => <span>{t('ncrm_generalsetting_preferences_desk_priority')}</span>
      },
      {
