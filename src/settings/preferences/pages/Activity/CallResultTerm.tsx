...
const CallResultTerm = (props: CallResultTermProps) => {
    ...
    () => [
      {
        ...
        header: () => <span>{t('ncrm_generalsetting_preferences_activity_call_result')}</span>
      },
      {
