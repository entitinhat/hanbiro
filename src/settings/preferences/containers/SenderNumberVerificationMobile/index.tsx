 ...
 * @returns
 */
const SenderNumberVerificationMobile: React.FC<SenderNumberVerificationProps> = (props) => {
  ...
  const renderFields = () => {
    return (
      <>
        ...
        <Box marginX={3} marginTop={'20px'} marginBottom={8}>
          <Typography gutterBottom>
          ...
          <TextField fullWidth required />
          <Box sx={{ display: 'flex', justifyContent: 'right', mt: 1 }}>
            <Button variant="contained" color="success" sx={{ py: 0.5 }} size="small">
...
export default SenderNumberVerificationMobile;
