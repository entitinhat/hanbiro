...
//menu
import CtaListGridCard from '@settings/digital/cta/components/CtaListGridCard'; //custom
...
const PageBody = (props: BodyProps) => {
  ...
  console.log('🚀 ~ file: PageBody.tsx:47 ~ PageBody ~ itemsList', itemsList);
  ...
  const mapColumns = getMapColumns();
  const tableColumns = useMemo<ColumnDef<any>[]>(
    () => [
      ...
      ...makeTable8Columns(tableFields, mapColumns, { category }, [])
    ],
      ...
      case ListType.SPLIT:
        ...
        return (
          <ListGrid {...listGridProps}>
            {(props) => {
              return <CtaListGridCard {...props} category={category} isSplitMode={isSplitMode} />;
            }}
          </ListGrid>
        );
      default:
