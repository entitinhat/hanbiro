...
//project
import { useSiteSurveyAnswerCreate, useSurveyAnswerCreate } from '@settings/digital/survey/hooks/useSurveyMutations';
...
//local
import SurveyTitleView from '../components/SurveyTitleView';
