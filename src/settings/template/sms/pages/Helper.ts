...
export const parseFieldsSMSView = (layoutView: any, menuApi: string) => {
  let fields: any[] = [];
...
export const parseFieldsSMS = (mapFields: any, fields: any) => {
  ...
  field.languageKey = 'ncrm_setting_template_message_type'; // Message Type
...
export const parseFieldsListSMS = (layoutList: any, menuApi: string) => {
  let fields: any[] = [];
  ...
  if (menuApi == 'sms') {
    fields = parseFieldsSMSList(mapFields, fields);
    let tmp = { ...layoutList };
...
export const parseFieldsSMSList = (mapFields: any, fields: any) => {
  let newFields: any[] = [];
  let field: any = {};
