...
import { TEMPLATE_MESSAGE_TYPE_OPTIONS_ENUM, TEMPLATE_STAGE_OPTIONS, TEMPLATE_TYPE_OPTIONS_ENUM } from '../constants';
...
export const groupByOptionsSMS: LabelValue[] = [
...
export const filterByOptionsSMS = [
  {
    ...
    setValue: (value: any) => {
      return TEMPLATE_MESSAGE_TYPE_OPTIONS_ENUM?.find((v: any) => v.value === value);
    }
  },
  {
