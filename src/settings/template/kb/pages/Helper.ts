...
export const parseFieldsKBView = (layoutView: any, menuApi: string) => {
  let fields: any[] = [];
  ...
  fields = parseFieldsKB(mapFields, fields);
  let tmp = { ...layoutView };
...
export const parseFieldsKB = (mapFields: any, fields: any) => {
  let newFields: any[] = [];
...
export const parseFieldsListKB = (layoutList: any, menuApi: string) => {
  let fields: any[] = [];
  ...
  fields = parseFieldsKBList(mapFields, fields);
  let tmp = { ...layoutList };
...
export const parseFieldsKBList = (mapFields: any, fields: any) => {
  let newFields: any[] = [];
  let field: any = {};
