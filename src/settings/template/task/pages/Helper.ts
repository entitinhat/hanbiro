...
export const parseFieldsTaskView = (layoutView: any, menuApi: string) => {
  let fields: any[] = [];
  ...
  fields = parseFieldsTask(mapFields, fields);
  let tmp = { ...layoutView };
...
export const parseFieldsTask = (mapFields: any, fields: any) => {
  let newFields: any[] = [];
  ...
  field.languageKey = 'ncrm_setting_template_task_type'; // Task type
  field.keyName = 'subType';
...
export const parseFieldsListTask = (layoutList: any, menuApi: string) => {
  let fields: any[] = [];
  ...
  fields = parseFieldsTaskList(mapFields, fields);
  let tmp = { ...layoutList };
...
export const parseFieldsTaskList = (mapFields: any, fields: any) => {
  let newFields: any[] = [];
  let field: any = {};
