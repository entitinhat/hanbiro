...
interface QuoteMainPageProps {}

const QuoteMainPage = (props: QuoteMainPageProps) => {
  useLanguageByMenu([queryKeys.settingMenuTemplatesGet]);

  const groupTemplate = groupTemplates[keyNames.KEY_MENU_TEMPLATE_QUOTE];
                ...
                {({ isSplitMode }: any) => {
                  return isSplitMode ? (
                    <SplitView
                      ...
                      rightPane={
                        <Box className="pane-content" style={{ flex: 1 }}>
