...
export const parseFieldsView = (layoutView: any, menuApi: string) => {
  let fields: any[] = [];
  ...
  fields = parseFields(mapFields, fields);
  let tmp = { ...layoutView };
...
export const parseFields = (mapFields: any, fields: any) => {
  let newFields: any[] = [];
...
const _parseFieldsList = (mapFields: any, fields: any) => {
  let newFields: any[] = [];
  let field: any = {};
...
export const parseFieldsList = (layoutList: any, menuApi: string) => {
  ...
  fields = _parseFieldsList(mapFields, fields);
  let tmp = { ...layoutList };
