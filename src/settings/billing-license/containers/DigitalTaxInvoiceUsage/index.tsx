...
const dummyData = [
  { id: 1, date: '5/4/2022', user: 'asd', subject: 'asd', amount: 10 },
  { id: 2, date: '5/4/2022', user: 'asd 2', subject: 'asd 2', amount: 10 }
];

const DigitalTaxInvoiceUsage = () => {
  ...
  return (
    <Box border={border}>
      <Box borderBottom={border} p={2}>
        <Typography fontWeight={500}>Digital Tax Invoice Usage</Typography>
      </Box>
      <Box>{TableMemo}</Box>
    </Box>
  );
};
export default DigitalTaxInvoiceUsage;
