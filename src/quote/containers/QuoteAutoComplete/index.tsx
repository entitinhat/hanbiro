...
import { useAutoCompleteQuotes } from '@quote/hooks/useQuotes';
 ...
 * @returns
 */
const QuoteAutoComplete = (props: AutoCompleteProps) => {
  ...
  const [options, setOptions] = useState<readonly Quote[]>([]);
  ...
  const {
    ...
    isFetching
    //refetch,
  } = useAutoCompleteQuotes(searchText);
