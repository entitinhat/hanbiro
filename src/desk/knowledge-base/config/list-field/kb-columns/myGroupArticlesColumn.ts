...
const myGroupArticlesColumn = [
  ...
  // },
  // {
  //   keyName: keyNames.KEY_KNOWLEDGE_UPDATED_BY,
  //   languageKey: 'desk_knowledge_field_basic_updatedby',
  //   defaultViewInList: true,
  //   sortable: true,
  //   name: keyNames.KEY_KNOWLEDGE_UPDATED_BY,
...
export default myGroupArticlesColumn;
