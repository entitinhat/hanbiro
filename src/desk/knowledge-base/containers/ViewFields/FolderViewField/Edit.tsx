  ...
  return (
    <Box sx={{ p: 1 }}>
      <InputLabel sx={{ display: 'flex', alignItems: 'center' }}>
        <SpanLang sx={{ fontWeight: theme.typography.fontWeightMedium }} keyLang={'Category'} />
      </InputLabel>
      ...
      <Stack spacing={0.5} sx={{ pt: 2 }}>
        ...
        {selectedFolder && (
          <>
            <InputLabel sx={{ display: 'flex', alignItems: 'center' }}>
              <SpanLang sx={{ fontWeight: theme.typography.fontWeightMedium }} keyLang={'Child Folder'} />
            </InputLabel>
            <KBFolderAutoComplete
