...
const ReadMoreReadLess = (props: ReadMoreReadLessProps) => {
  const { children, limit = 250 } = props;
    ...
    <Grid container>
      ...
      >
        ...
        {children?.length > limit && (
          <Typography sx={{ cursor: 'pointer', color: theme.palette.primary.main }} component="span" onClick={toggleBtn}>
            {' '}
            {isReadMoreShown ? t('ncrm_desk_ticket_read_more') : t('ncrm_desk_ticket_read_less')}
          </Typography>
        )}
      </Grid>
    </Grid>
