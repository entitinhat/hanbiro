...
import { COMPETITOR_DELTED_OPTIONS, COMPETITOR_TOOLBAR_MORE_OPTIONS } from '@competitor/config/constants';
...
const Toolbar = (props: ToolbarProps) => {
  ...
  //more
  const moreOptions = COMPETITOR_TOOLBAR_MORE_OPTIONS.map((_option: LabelValueIcon) => ({ ..._option, label: t(_option.label) }));

  //more menu
  const moreMenuProps: DropdownProps = {
    items: isDeleteGroup ? COMPETITOR_DELTED_OPTIONS : moreOptions,
