...
//menu
import { dateByOptions, filterByOptions, groupByOptions, sortByOptions } from '@competitor/config/list-field';
import { KEY_NAME_COMPETITOR_NAME } from '@competitor/config/keyNames';
...
const Filter = (props: FilterProps) => {
  ...
  const handleSearchTextChange = (value: string) => {
    setSearch({ [KEY_NAME_COMPETITOR_NAME]: value });
  };
  ...
  return (
    <Box sx={{ height: 55 }}>
      <ListHeader
        ...
        searchByProps={{
          value: searchValues?.[KEY_NAME_COMPETITOR_NAME] || '',
