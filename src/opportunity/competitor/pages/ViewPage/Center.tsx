...
//menu
import OpportunityList from '@competitor/containers/OpportunityList';
    ...
    return [
      {
        ...
        iconPosition: 'start',
        tabComponent: (
          <OpportunityList menuSource={menuSource} menuCategory={menuCategory} menuSourceId={menuSourceId} layoutData={layoutData} />
        )
      },
      {
        default: false,
