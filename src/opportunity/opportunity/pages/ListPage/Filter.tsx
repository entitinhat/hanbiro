...
//menu
import { dateByOptions, filterByOptions, groupByOptions, sortByOptions } from '@opportunity/config/list-field';
import { KEY_NAME_OPPORTUNITY_TITLE } from '@opportunity/config/keyNames';
...
const Filter = (props: FilterProps) => {
  ...
  const handleSearchTextChange = (value: string) => {
    setSearch({ [KEY_NAME_OPPORTUNITY_TITLE]: value });
  };
  ...
  return (
    <Box sx={{ height: 55 }}>
      <ListHeader
        ...
        searchByProps={{
          value: searchValues?.[KEY_NAME_OPPORTUNITY_TITLE] || '',
