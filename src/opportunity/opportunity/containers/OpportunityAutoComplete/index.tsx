...
//menu
import { useAutoCompleteOpportunities } from '@opportunity/hooks/useOpportunities';
 ...
 * @returns
 */
const OpportunityAutoComplete = (props: AutoCompleteProps) => {
  ...
  const [options, setOptions] = useState<readonly Opportunity[]>([]);
  ...
  const {
    ...
    isFetching
    //refetch,
  } = useAutoCompleteOpportunities(searchText);
  ...
  return (
    <Autocomplete
      id="asynchronous-opportunity-list"
      multiple={!single}
      disabled={isDisabled}
      //readOnly={readOnly}
      //limitTags={3}
...
export default OpportunityAutoComplete;
