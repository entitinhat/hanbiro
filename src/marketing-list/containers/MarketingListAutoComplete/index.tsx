...
//menu
import { useMarketingLists } from '@marketing-list/hooks/useMarketingListMember';

interface MarketingListAutoCompleteProps {
  single?: boolean;
  placeholder?: string;
 ...
 * @returns
 */
const MarketingListAutoComplete = (props: MarketingListAutoCompleteProps) => {
  ...
  return (
    <Autocomplete
      id="asynchronous-marketing-list"
      multiple={!single}
      //disabled={isDisabled}
      //readOnly={readOnly}
      //limitTags={3}
...
export default MarketingListAutoComplete;
