...
const allMissedCallColumn = [
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_CONFIRM,
    languageKey: 'ncrm_activity_confirm',
    defaultViewInList: true,
    sortable: true,
    name: keyNames.KEY_NAME_ACTIVITY_CONFIRM,
    title: 'ncrm_activity_confirm'
  },
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_SUBJECT,
...
export default allMissedCallColumn;
