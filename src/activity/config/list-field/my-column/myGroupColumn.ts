...
export const myGroupColumnType1 = [
  {
  ...
  },
  {
    ...
    languageKey: 'activity_activity_field_basic_subject',
    defaultViewInList: true,
    sortable: true,
  ...
  },
  {
    ...
    languageKey: 'activity_activity_field_basic_to',
    defaultViewInList: true,
    sortable: false,
  ...
  },
  {
    ...
    languageKey: 'activity_activity_field_basic_activitydate',
    defaultViewInList: true,
    sortable: true,
  ...
  },
  {
    ...
    languageKey: 'activity_activity_field_basic_updated_at',
    defaultViewInList: true,
    sortable: true,
    name: keyNames.KEY_NAME_ACTIVITY_UPDATED_AT,
    title: 'activity_activity_field_basic_updated_at'
  }
];

export const myGroupColumnType2 = [
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_FROM,
    languageKey: 'activity_activity_field_basic_from',
...
/*export const myOverdueColumn = [
  ...
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_TYPE,
    languageKey: 'activity_activity_field_basic_type',
    defaultViewInList: true,
    sortable: false,
    name: keyNames.KEY_NAME_ACTIVITY_TYPE,
  ...
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_DUE_DATE,
    languageKey: 'activity_activity_field_basic_duedate',
    defaultViewInList: true,
    sortable: true,
    name: keyNames.KEY_NAME_ACTIVITY_DUE_DATE,
    title: 'activity_activity_field_basic_duedate'
  ...
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_STATUS,
    languageKey: 'activity_activity_field_basic_status',
    defaultViewInList: true,
    sortable: false,
    name: keyNames.KEY_NAME_ACTIVITY_STATUS,
    title: 'activity_activity_field_basic_status'
