...
//     languageKey: 'activity_email_field_basic_direction',
//     defaultViewInList: true,
//     sortable: true,
//     name: keyNames.KEY_NAME_ACTIVITY_DIRECTION,
//     title: 'activity_email_field_basic_direction'
//   },
//   {
...
//   },
//   {
//     keyName: keyNames.KEY_NAME_ACTIVITY_SEND_TYPE,
//     languageKey: 'activity_email_field_basic_sendtype',
//     defaultViewInList: true,
//     sortable: false,
//     name: keyNames.KEY_NAME_ACTIVITY_SEND_TYPE,
//     title: 'activity_email_field_basic_sendtype'
//   },
//   {
//     keyName: keyNames.KEY_NAME_ACTIVITY_START_TIME,
//     languageKey: 'ncrm_activity_email_date',
//     defaultViewInList: true,
//     sortable: true,
//     name: keyNames.KEY_NAME_ACTIVITY_START_TIME,
//     title: 'ncrm_activity_email_date'
//   },
//   {
...
//     languageKey: 'activity_email_field_basic_status',
//     defaultViewInList: true,
//     sortable: false,
//     name: keyNames.KEY_NAME_ACTIVITY_STATUS,
//     title: 'activity_email_field_basic_status'
//   }
// ];
...
const allEmailColumn = [
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_SUBJECT,
    languageKey: 'activity_email_field_basic_subject', // Subject
    defaultViewInList: true,
    sortable: true,
    name: keyNames.KEY_NAME_ACTIVITY_SUBJECT,
    title: 'activity_email_field_basic_subject'
  ...
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_TO,
    languageKey: 'ncrm_activity_customer', // Customer
    defaultViewInList: true,
    sortable: true,
    name: keyNames.KEY_NAME_ACTIVITY_TO,
    title: 'ncrm_activity_customer'
