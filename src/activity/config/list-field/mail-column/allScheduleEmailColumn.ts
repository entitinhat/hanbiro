...
const allScheduleEmailColumn = [
  ...
  },
  {
   ...
   {
    keyName: keyNames.KEY_NAME_ACTIVITY_START_TIME,
    languageKey: 'ncrm_activity_email_received_date',
    defaultViewInList: true,
    sortable: true,
    name: keyNames.KEY_NAME_ACTIVITY_START_TIME,
    title: 'ncrm_activity_email_received_date'
  },
  {
    keyName: keyNames.KEY_NAME_ACTIVITY_EMAIL_STATUS,
    languageKey: 'ncrm_activity_email_status',
    defaultViewInList: true,
    sortable: true,
    name: keyNames.KEY_NAME_ACTIVITY_EMAIL_STATUS,
    title: 'ncrm_activity_email_status'
  },
];

export default allScheduleEmailColumn;
