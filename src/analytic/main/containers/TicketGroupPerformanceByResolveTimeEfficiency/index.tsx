...
const TicketGroupPerformanceByResolveTimeEfficiency = (props: ChartComponentProps) => {
  ...
  const chartData = results?.reduce(
    (f: any, v: any) => {
      ...
      f['s'].push(v?.counting?.resolveTimeEfficiency ?? 0);
      return f;
    },
    { l: [], s: [] },
  ) ?? { l: [], s: [] };
...
export default TicketGroupPerformanceByResolveTimeEfficiency;
