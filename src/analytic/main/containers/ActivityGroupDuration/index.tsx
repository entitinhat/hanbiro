...
const ActivityGroupDuration = (props: ChartComponentProps) => {
  ...
  const {data} = useChartQuery(restProps, () => {
    return useGetActivityDateCounting(filters ?? {}, {forWhichChart: 'ActivityGroupDuration'});
  });
  ...
  let oData: any = {
    categories: [],
    duration: {
      name: me ? t('ncrm_dashboard_chart_field_my_group_duration') : t('ncrm_dashboard_chart_field_group_duration'),
      data: []
    },
    avgDuration: {
...
export default ActivityGroupDuration;
