...
import { publicPageLayoutsAtom } from '@public-page/site/store/atom';
import { getPageLayoutForMenu, getPagelayoutFromStorage, storePageLayoutToStorage } from '@base/services/pagelayoutService';

//get pagelayout from recoil or Indexed DB
export const useSitePageLayoutByMenu = (menu: string, mode: string, token: string) => {
  const [loading, setLoading] = useState(false);

  //get data from recoil
  const [pageLayouts, setPageLayouts] = useRecoilState(publicPageLayoutsAtom);
