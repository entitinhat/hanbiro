...
import { MENU_PROJECT, MENU_PROJECT_PLANNING } from '@base/config/menus';
import useListPageSettings from '@base/hooks/user-setting/useListPageSetting';
import { Stack, useMediaQuery, useTheme } from '@mui/material';
import { usePlanningList } from '@project/hooks/usePlanning';
import { GET_PLANNINGS } from '@project/services/planning';
