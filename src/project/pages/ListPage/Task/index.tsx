...
import { useTaskList } from '@project/hooks/useTask';
import { GET_LIST_TASKS } from '@project/services/task';
...
const TaskListPage = ({ isSplitMode }: ListPageProps) => {
  ...
  const { results: listData, refetch } = useTaskList(
    GET_LIST_TASKS,
    {
      filter: filtersQuery
    },
